...
module tb_Weights_Buffer;
    ...
    logic signed [DATA_WIDTH-1:0]  outputs [MATRIX_SIZE-1:0];
       ...
       Weights_Buffer #(.MATRIX_SIZE(MATRIX_SIZE), .DATA_WIDTH((DATA_WIDTH))) uut (
       .rstn                (rstn),
       .clk                 (clk),
